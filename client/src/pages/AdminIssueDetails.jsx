      ...
      <div className="page">
        ...
        <main className="container">
          <div className="not-found">
            ...
            <Link to="/admin" className="back-link">Go back to Dashboard</Link>
          </div>
        </main>
      </div>
    )
     ...
     <div className="page">
      ...
      <main className="container">
        ...
        <div className="top-bar">
          ...
          <DeleteIssue  className="delete-issue-button" issueId={issue._id} onDelete={() => window.location.href = '/admin'} />
        </div>
        ...
        <div className="detail-card">
          ...
          <div className="detail-body">
            ...
            <div className="status-buttons">
              <button
                className="table-status status-pending"
                onClick={() => onUpdateStatus("Yet to Work")}
              >
                Mark Yet to Work
              </button>

              <button
                className=" table-status status-working"
